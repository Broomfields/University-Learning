...
-- TSQL Tutorial 4: Exercise 1 - Solutions
---------------------------------------------------------------------
USE TSQL;
GO
---------------------------------------------------------------------
...
-- 
-- Execute the written statement and compare the results that you got with the possible result(s) of the query. Your results will be different because of the current date and time value.
--
...
-- useful when working with versions of SQL Server before SQL Server 2008
...
--
-- Execute the written statement and compare the results that you got with the possible result(s) of the query. Some results will be different because of the current date and time value.
---------------------------------------------------------------------
