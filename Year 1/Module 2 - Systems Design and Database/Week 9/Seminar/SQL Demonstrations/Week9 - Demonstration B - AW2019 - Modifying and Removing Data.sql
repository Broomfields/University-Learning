-- Week - 09 - Using DML to modify Data
-- Author: Mansha Nawaz/Dr Yar Muhammad

-- Demonstration - Demonstration B - Modifying and Removing Data
...
-- Check to Drop the table [Store] if it exists
...
GO
-- create a new Store Table - copying Sales.Store into dbo.Store
...
-- Task - run the code and note the error if the table already exisit.  
-- Revise and uncomment the following code to drop the table [StoreBackUp] if it exists
